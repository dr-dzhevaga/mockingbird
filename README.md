...
# Settings #
Settings is organized as a tree and loaded from YAML or JSON file during program start. You can also specify settings file reload period (see [Command-line options](#command-line-options)).
